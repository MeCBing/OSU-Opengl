...
const char *WINDOWTITLE = { "OpenGL / GLUT Project 1 -- Castle" };
...
Display( )
{
	...
	glLoadIdentity( );
	glColor3f( 1., 1., 1. );
	DoRasterString( 5., 5., 0., "This is a castle" );
